...
<head>
    ...
    <title>Login - Vendor Dashboard</title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or
                <a href="{{ route('vendor.register') }}" class="font-medium text-blue-600 hover:text-blue-500">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form class="space-y-6" action="{{ route('vendor.login') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('vendor.password.request') }}" class="font-medium text-blue-600 hover:text-blue-500">
